import { FaQrcode, FaSignOutAlt, FaUser } from 'react-icons/fa';
...
const ScannerHeader = ({ scanner, user, title }: ScannerHeaderProps) => {
        ...
        <div className="flex items-center justify-between h-14 md:h-16">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 hidden md:block">Welcome, {scanner.name}</p>
            </div>
          </div>
          <div className="flex items-center gap-2">
            {user && (
            ...
            <button
              ...
              className="inline-flex items-center justify-center h-9 w-9 md:h-auto md:w-auto md:px-4 md:py-2 border border-gray-300 text-sm font-medium rounded-lg text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors"
            >
